 ...
 *   setLanguage('en');
 *   const label = t('trayShowWindow'); // "Open TopVanAI"
...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    // Tray menu
    trayShowWindow: '打开 TopVanAI',
    trayNewTask: '新建任务',
    trayViewCompletedTask: '查看完成的任务',
    trayCompletedTaskTooltip: 'TopVanAI - {count} 个任务已完成',
    traySettings: '设置',
    trayQuit: '退出',
    ...
    coworkErrorFreeQuotaExhausted:
      '当前模型的免费额度已用完。请在账户页面或自建服务后台检查套餐配置。',
    ...
    coworkGatewaySessionSyncTimeout: 'OpenClaw 引擎响应缓慢，消息尚未发送。请等待 1~2 分钟后重新发送；若频繁出现，请检查系统内存与磁盘占用，并将 TopVanAI 加入杀毒软件白名单。',
    ...
    dataMigrationBackupDialogTitle: '备份 TopVanAI 数据',
    dataMigrationRestoreDialogTitle: '导入 TopVanAI 数据备份',
    dataMigrationBackupArchiveFilter: 'TopVanAI 备份包',
    dataMigrationAllFilesFilter: '所有文件',
    dataMigrationBackupBlockedByActiveWorkloads:
      '当前有正在运行的 Agent 或定时任务，请停止或等待任务完成后再备份。',
    dataMigrationRestoreProgressTitle: '正在导入 TopVanAI 数据',
  ...
  en: {
    // Tray menu
    trayShowWindow: 'Open TopVanAI',
    trayNewTask: 'New Task',
    trayViewCompletedTask: 'View Completed Task',
    trayCompletedTaskTooltip: 'TopVanAI - {count} completed task(s)',
    ...
    coworkErrorFreeQuotaExhausted:
      'The current model\'s free quota has been used up. Check your account page or self-hosted service admin settings.',
    ...
    coworkGatewaySessionSyncTimeout: 'The OpenClaw engine is responding slowly and your message has not been sent. Please wait a minute or two and resend. If this happens frequently, check system memory and disk usage, and add TopVanAI to your antivirus allowlist.',
    ...
    // Data migration dialogs
    dataMigrationBackupDialogTitle: 'Back Up TopVanAI Data',
    dataMigrationRestoreDialogTitle: 'Import TopVanAI Data Backup',
    dataMigrationBackupArchiveFilter: 'TopVanAI Backup',
    ...
    dataMigrationRestoreProgressTitle: 'Importing TopVanAI data',
    dataMigrationRestoreProgressDesc:
      'Restoring the backup and validating data. TopVanAI will restart automatically when finished.',
