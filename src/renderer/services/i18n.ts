...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    // 隐私协议弹窗
    privacyDialogTitle: 'TopVan LobsterAI服务协议',
    privacyDialogDesc: '在使用TopVan LobsterAI之前，请您仔细阅读{link}内容，并进行确认。',
    privacyDialogLinkText: 'TopVan LobsterAI服务协议',
  ...
  en: {
    ...
    // Privacy dialog
    privacyDialogTitle: 'TopVan LobsterAI Terms of Service',
    privacyDialogDesc:
      'Before using TopVan LobsterAI, please carefully read the {link} and confirm.',
    privacyDialogLinkText: 'TopVan LobsterAI Terms of Service',
