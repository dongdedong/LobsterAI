...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    aboutExportLogsPartial: '日志导出成功（部分关键日志缺失，已按空文件补齐）',
    localByokOnlinePageUnavailable: '无后端 MVP 暂未提供在线页面',
    licenseTitle: '本地授权',
    licenseDescription: 'MVP 使用本地 License 控制商业授权。没有导入 License 时默认提供 14 天本地试用；过期、签名错误或机器不匹配时将禁止新建 Cowork 任务，但不会删除历史数据。',
    licenseStatusLoading: '读取中',
    licenseStatusValid: '已授权',
    licenseStatusTrial: '试用中',
    licenseStatusMissing: '未授权',
    licenseStatusExpired: '已过期',
    licenseStatusInvalidSignature: '签名无效',
    licenseStatusMachineMismatch: '机器不匹配',
    licenseStatusFeatureMissing: '缺少功能',
    licenseStatusInvalidFormat: '格式无效',
    licenseCustomer: '客户',
    licensePlan: '方案',
    licenseExpiresAt: '到期时间',
    licenseFeatures: '功能',
    licenseMachineCode: '机器码',
    licenseEmptyValue: '未提供',
    licenseTrialFeatures: '试用功能',
    licenseImport: '导入 License',
    licenseClear: '清除 License',
    licenseImportDialogTitle: '选择 License 文件',
    licenseImportFailed: 'License 导入失败',
    licenseCoworkBlocked: '当前授权不可用，请导入有效 License 或联系实施人员处理。',
    testMode: '测试模式',
    remoteServicesTitle: '远程服务',
    remoteServicesDescription: '选择客户端连接官方服务、自建轻量服务，或只使用本地/BYOK 模型配置。',
    remoteServicesMode: '服务模式',
    remoteServicesModeOfficial: '官方服务',
    remoteServicesModeLocalByok: '本地 / BYOK',
    remoteServicesModeSelfHosted: '自建服务',
    remoteServicesServerBaseUrl: '自建服务地址',
    remoteServicesServerModelMode: '服务端模型',
    remoteServicesServerModelOfficial: '官方模型',
    remoteServicesServerModelManagedProxy: '自建代理模型',
    remoteServicesServerModelDisabled: '禁用服务端模型',
    remoteServicesLocalByokHint: '本地 / BYOK 模式会禁用服务端模型、媒体生成、实时语音和 HTML 分享；请在模型设置中配置第三方或本地模型。',
    remoteServicesBaseUrlRequired: '请填写自建服务地址',
    remoteServicesBaseUrlInvalid: '自建服务地址必须是有效的 HTTP 或 HTTPS URL',
    theme: '主题',
    appearance: '外观',
    language: '语言',
    light: '浅色',
    ...
    copied: '已复制',
    copyrightHolder: 'TopVan 版权所有',
    copyrightStatement: 'Copyright © {year} TopVan. All Rights Reserved.',
    ...
    shortcutOpenCowork: '打开 TopVanAI',
    ...
    shortcutDescNewChat: '开始一个新的 TopVanAI 任务',
    shortcutDescFocusPrompt: '跳回 TopVanAI 并聚焦当前输入框',
    ...
    shortcutDescOpenCowork: '切换到 TopVanAI 任务视图',
    ...
    authQuotaExhausted:
      '今日免费额度已用完。您可以登录 TopVanAI Portal 购买套餐或积分包继续使用，或在设置中配置自己的 API Key。',
    authTopUpLink: '充值',
    authSettingsLink: '设置',
    ...
    authZeroCredits: '0积分',
    authLocalByokTitle: '本地 / BYOK 模式',
    authLocalByokDescription: '当前不使用云账号、积分、充值或邀请功能。请在模型设置中配置第三方或本地模型。',
    planFree: '免费',
    planStandard: '标准',
    planAdvanced: '进阶',
    planPro: '专业',
    ...
    artifactPreviewCardLobsterBrowser: 'TopVan 龙虾浏览器',
    artifactPreviewCardOpenInLobsterBrowser: '在 TopVan 龙虾浏览器中打开',
    ...
    coworkWorkingDirectoryHint: 'TopVanAI 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 TopVanAI 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 TopVanAI 的行为',
    coworkModelSettingsRequired: '请先在模型设置中启用一个可用 Provider，并完成 API Key / 本地模型配置与连接测试。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: 'TopVanAI 使用模型设置中的当前模型与提供商配置。',
    coworkModelSettingsAction: '前往模型设置',
    byokQuickStartTitle: 'BYOK 快速配置',
    byokQuickStartReady: '已可用',
    byokQuickStartNotReady: '待配置',
    byokQuickStartDescription: 'MVP 版本不提供云端模型代理，请使用自己的模型 Key、企业模型网关，或本地 Ollama / LM Studio。',
    byokQuickStartStepProvider: '1. 选择一个推荐 Provider，例如 DeepSeek、Qwen、OpenAI、Ollama 或 LM Studio。',
    byokQuickStartStepCredential: '2. 填写 API Key 或确认本地模型服务地址，并至少保留一个模型。',
    byokQuickStartStepTest: '3. 点击“测试连接”，成功后即可开始 Cowork 任务。',
    byokRecommendedBadge: '推荐',
    providerSetupReady: '可用',
    providerSetupDisabled: '未启用',
    providerSetupMissingApiKey: '缺少 Key',
    providerSetupMissingModel: '缺少模型',
    providerRecommendedConfigTitle: '推荐配置',
    providerRecommendedConfigHint: '恢复该 Provider 的推荐 Base URL、协议格式和默认模型；不会覆盖已填写的 API Key。',
    applyRecommendedConfig: '应用推荐配置',
    connectionFailureAuthHint: '请检查 API Key 是否正确、是否已复制完整，以及该 Key 是否有当前模型的调用权限。',
    connectionFailureModelHint: '请检查模型 ID 是否填写正确，或先在该 Provider 下添加一个上游实际支持的模型。',
    connectionFailureBaseUrlHint: '请检查 Base URL 是否匹配该 Provider 的协议格式。OpenAI 兼容服务通常以 /v1 结尾，本地 Ollama 默认为 http://localhost:11434/v1。',
    connectionFailureRateLimitHint: '上游返回限流或额度不足。请稍后重试，或检查上游账号额度、并发限制和计费状态。',
    connectionFailureNetworkHint: '客户端无法连接到上游服务。请检查网络、系统代理、防火墙，或确认本地 Ollama / LM Studio 已启动。',
    connectionFailureUnknownHint: '请根据上游返回的错误详情检查 Provider 配置；如果仍无法定位，可以导出日志交给实施或研发人员。',
    ...
    openClawDataBackupBlockingTitle: '正在备份 TopVanAI 数据',
    ...
    openClawDataMigrationBlockingTitle: '正在准备导入 TopVanAI 数据',
    ...
    openClawDataMigrationConfirmTitle: '导入 TopVanAI 数据备份？',
    ...
    coworkConfigSaveFailed: '保存 TopVanAI 配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: 'TopVanAI 请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: 'TopVanAI 需要你做出选择',
    coworkToolName: '工具名称',
    ...
    imNimQrDisabled: '当前 MVP 未启用云信扫码登录，请手动填写机器人信息。',
    ...
    browserWebAccessDescription: '使用 TopVanAI 独立浏览器，管理网页打开方式和访问规则。',
    ...
    browserProfileManagedDescription: 'TopVanAI 启动一个专用浏览器，稳定、干净。',
    ...
    browserFollowGlobalProxyDescription: '默认开启。关闭后仅作为 TopVanAI 配置保留，当前版本仍受浏览器自身代理设置影响。',
    ...
    browserBlockedHostnamesDescription: 'TopVanAI 不会打开这些网站',
    browserHostnameListEmpty: '尚未添加域名',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: '添加已屏蔽域名',
    browserAddBlockedHostnameDescription: '这意味着 TopVanAI 不会打开此 URL',
    browserAddAllowedHostnameTitle: '添加允许域名',
    browserAddAllowedHostnameDescription: '这意味着 TopVanAI 可以打开此域名',
    ...
    // 隐私协议弹窗
    privacyDialogTitle: 'TopVanAI服务协议',
    privacyDialogDesc: '在使用TopVanAI之前，请您仔细阅读{link}内容，并进行确认。',
    privacyDialogLinkText: 'TopVanAI服务协议',
    privacyDialogAccept: '我已阅读并同意',
    privacyDialogReject: '拒绝',
    welcomeTitle: '欢迎使用TopVanAI',
    ...
    apiKeyHint: '请输入自有邮箱网关服务签发的 API Key。当前 MVP 不再跳转原厂在线控制台。',
    emailApiKeyConsoleUnavailable: '当前 MVP 暂未内置在线 API Key 控制台，请使用自有邮箱网关服务签发的 API Key。',
  ...
  en: {
    ...
    aboutExportLogsPartial: 'Logs exported (some required logs were missing and filled as empty files)',
    localByokOnlinePageUnavailable: 'Online pages are not available in the backend-free MVP',
    licenseTitle: 'Local License',
    licenseDescription: 'The MVP uses a local license for commercial authorization. Without an imported license, a 14-day local trial is available. Expired, invalid, or machine-mismatched licenses block new Cowork tasks without deleting existing data.',
    licenseStatusLoading: 'Loading',
    licenseStatusValid: 'Licensed',
    licenseStatusTrial: 'Trial',
    licenseStatusMissing: 'Unlicensed',
    licenseStatusExpired: 'Expired',
    licenseStatusInvalidSignature: 'Invalid signature',
    licenseStatusMachineMismatch: 'Machine mismatch',
    licenseStatusFeatureMissing: 'Feature missing',
    licenseStatusInvalidFormat: 'Invalid format',
    licenseCustomer: 'Customer',
    licensePlan: 'Plan',
    licenseExpiresAt: 'Expires at',
    licenseFeatures: 'Features',
    licenseMachineCode: 'Machine code',
    licenseEmptyValue: 'Not provided',
    licenseTrialFeatures: 'Trial features',
    licenseImport: 'Import License',
    licenseClear: 'Clear License',
    licenseImportDialogTitle: 'Select license file',
    licenseImportFailed: 'Failed to import license',
    licenseCoworkBlocked: 'The current license is not usable. Import a valid license or contact your delivery engineer.',
    testMode: 'Test Mode',
    remoteServicesTitle: 'Remote Services',
    remoteServicesDescription: 'Choose whether the client connects to official services, a self-hosted lightweight service, or only local/BYOK model providers.',
    remoteServicesMode: 'Service Mode',
    remoteServicesModeOfficial: 'Official Services',
    remoteServicesModeLocalByok: 'Local / BYOK',
    remoteServicesModeSelfHosted: 'Self-hosted Service',
    remoteServicesServerBaseUrl: 'Self-hosted Service URL',
    remoteServicesServerModelMode: 'Server Models',
    remoteServicesServerModelOfficial: 'Official Models',
    remoteServicesServerModelManagedProxy: 'Self-hosted Model Proxy',
    remoteServicesServerModelDisabled: 'Disable Server Models',
    remoteServicesLocalByokHint: 'Local / BYOK mode disables server models, media generation, realtime voice, and HTML sharing. Configure third-party or local models in Model settings.',
    remoteServicesBaseUrlRequired: 'Enter the self-hosted service URL',
    remoteServicesBaseUrlInvalid: 'The self-hosted service URL must be a valid HTTP or HTTPS URL',
    theme: 'Theme',
    ...
    copied: 'Copied',
    copyrightHolder: 'TopVan. All rights reserved.',
    copyrightStatement: 'Copyright © {year} TopVan. All Rights Reserved.',
    ...
    shortcutScopeHint: 'Shortcuts only run while the TopVanAI window is focused; global shortcuts are ignored while editing text fields.',
    ...
    shortcutOpenCowork: 'Open TopVanAI',
    ...
    shortcutDescNewChat: 'Start a new TopVanAI task',
    shortcutDescFocusPrompt: 'Return to TopVanAI and focus the current prompt',
    ...
    shortcutDescOpenCowork: 'Switch to the TopVanAI task view',
    ...
    authQuotaExhausted:
      'Daily free quota exhausted. Visit TopVanAI Portal to purchase a plan or credits, or configure your own API Key in Settings.',
    ...
    authLocalByokTitle: 'Local / BYOK Mode',
    authLocalByokDescription: 'Cloud accounts, credits, top-ups, and invites are disabled. Configure third-party or local models in Model settings.',
    planFree: 'Free',
    ...
    artifactPreviewCardLobsterBrowser: 'TopVanAI Browser',
    artifactPreviewCardOpenInLobsterBrowser: 'Open in TopVanAI Browser',
    ...
    // TopVanAI
    cowork: 'TopVanAI',
    coworkSettings: 'TopVanAI Settings',
    ...
    coworkWorkingDirectoryHint: 'TopVanAI will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for TopVanAI...',
    coworkSystemPromptHint: "Optional system prompt to customize TopVanAI's behavior",
    coworkModelSettingsRequired: 'Enable one available provider in Model Settings, then configure the API key or local model endpoint and test the connection.',
    coworkModelSettingsTitle: 'Model Settings',
    coworkModelSettingsHint:
      'TopVanAI uses the current model and provider configuration from Model Settings.',
    coworkModelSettingsAction: 'Go to Model Settings',
    byokQuickStartTitle: 'BYOK Quick Start',
    byokQuickStartReady: 'Ready',
    byokQuickStartNotReady: 'Setup needed',
    byokQuickStartDescription: 'The MVP does not proxy cloud models. Use your own model key, enterprise model gateway, or local Ollama / LM Studio runtime.',
    byokQuickStartStepProvider: '1. Choose a recommended provider such as DeepSeek, Qwen, OpenAI, Ollama, or LM Studio.',
    byokQuickStartStepCredential: '2. Enter an API key or confirm the local model endpoint, and keep at least one model configured.',
    byokQuickStartStepTest: '3. Click "Test Connection". After it succeeds, you can start a Cowork task.',
    byokRecommendedBadge: 'Recommended',
    providerSetupReady: 'Ready',
    providerSetupDisabled: 'Disabled',
    providerSetupMissingApiKey: 'Missing key',
    providerSetupMissingModel: 'Missing model',
    providerRecommendedConfigTitle: 'Recommended configuration',
    providerRecommendedConfigHint: 'Restore the recommended Base URL, protocol format, and default models for this provider. Existing API keys are kept.',
    applyRecommendedConfig: 'Apply recommended config',
    connectionFailureAuthHint: 'Check that the API key is correct, copied completely, and allowed to call the selected model.',
    connectionFailureModelHint: 'Check that the model ID is correct, or add a model actually supported by the upstream provider.',
    connectionFailureBaseUrlHint: 'Check whether the Base URL matches the provider protocol. OpenAI-compatible services usually end with /v1, and local Ollama defaults to http://localhost:11434/v1.',
    connectionFailureRateLimitHint: 'The upstream service reported rate limiting or insufficient quota. Retry later or check account quota, concurrency limits, and billing status.',
    connectionFailureNetworkHint: 'The client cannot reach the upstream service. Check network, system proxy, firewall, or whether local Ollama / LM Studio is running.',
    connectionFailureUnknownHint: 'Use the upstream error details to review the provider settings. If it is still unclear, export logs for delivery or engineering support.',
    ...
    openClawDataBackupBlockingTitle: 'Backing up TopVanAI data',
    ...
    openClawDataMigrationBlockingTitle: 'Preparing to import TopVanAI data',
    ...
    openClawDataMigrationConfirmTitle: 'Import TopVanAI data backup?',
    ...
    coworkConfigSaveFailed: 'Failed to save TopVanAI settings. Please try again.',
    ...
    coworkPermissionDescription: 'TopVanAI is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: 'TopVanAI needs your input',
    ...
    imNimQrDisabled: 'NIM QR login is not enabled in this MVP. Enter bot credentials manually.',
    ...
    browserWebAccessDescription: 'Use the TopVanAI separate browser and manage page access rules.',
    ...
    browserProfileManagedDescription: 'TopVanAI starts a dedicated browser that is stable and clean.',
    ...
    browserFollowGlobalProxyDescription: 'Enabled by default. Turning it off is stored for TopVanAI, but this version can still be affected by the browser proxy settings.',
    ...
    browserBlockedHostnamesDescription: 'TopVanAI will not open these websites',
    browserHostnameListEmpty: 'No domains added yet',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: 'Add blocked domain',
    browserAddBlockedHostnameDescription: 'This means TopVanAI will not open this URL',
    browserAddAllowedHostnameTitle: 'Add allowed domain',
    browserAddAllowedHostnameDescription: 'This means TopVanAI can open this domain',
    ...
    // Privacy dialog
    privacyDialogTitle: 'TopVanAI Terms of Service',
    privacyDialogDesc:
      'Before using TopVanAI, please carefully read the {link} and confirm.',
    privacyDialogLinkText: 'TopVanAI Terms of Service',
    privacyDialogAccept: 'I have read and agree',
    privacyDialogReject: 'Decline',
    welcomeTitle: 'Welcome to TopVanAI',
    ...
    emailApiKey: 'API Key',
    emailApiKeyPlaceholder: 'ck_live_xxxxxxxx',
    apiKeyHint: 'Enter the API Key issued by your own email gateway service. The MVP no longer opens the upstream online console.',
    emailApiKeyConsoleUnavailable: 'The MVP does not include an online API Key console. Use the API Key issued by your own email gateway service.',
