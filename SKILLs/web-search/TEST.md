...
This guide walks through testing the entire Web Search Skill integration with TopVanAI.

## Prerequisites

1. TopVanAI built and ready to run
2. Google Chrome installed
3. Internet connection available

## Test 1: Service Auto-Start

**Objective:** Verify that the Bridge Server starts automatically with TopVanAI.

**Steps:**

1. Start TopVanAI in development mode:
   ```bash
...
**Expected Result:** ✅ Bridge Server starts automatically within 3 seconds of TopVanAI launch.
...
1. Open a terminal while TopVanAI is running
...
**Objective:** Verify graceful shutdown of services when TopVanAI quits.

**Steps:**

1. With TopVanAI running and searches completed, quit the application
...
1. Start TopVanAI (ensure headless is false in config)
...
- ✅ Server auto-starts with TopVanAI
