...
/**
 * Apply version-specific TopVanAI patches to the openclaw source tree.
 *
...
// This removes stale patches left by a different TopVanAI branch that may have
