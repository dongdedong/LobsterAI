 ...
 * and waits for the user's response via an HTTP callback to TopVanAI.
 *
 * This enables delete-confirmation modals on the TopVanAI desktop app
...
const plugin = {
  ...
  description: 'Structured user confirmation tool for TopVanAI desktop.',
  configSchema: {
  ...
  register(api: OpenClawPluginApi) {
    ...
    api.registerTool((ctx) => {
      // Only enable for TopVanAI desktop sessions (sessionKey starts with 'agent:main:lobsterai:').
